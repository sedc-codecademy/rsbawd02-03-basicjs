...
console.log((myHeader.innerHTML += "<span>prosirenje</span>"));
console.log((myHeader.outerHTML += "<span> prosirenje </span>"));
console.log("====================================================");
...
titleInDiv.innerText += " from Jelena";
